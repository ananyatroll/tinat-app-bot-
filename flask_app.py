...
CANONICAL_PRODUCTS = {
    ...
    'coc_medicine': {
        'id': 'coc_medicine',
        'category': 'coc',
        'label': 'Medicine COC Exam Preparation',
        'priceCents': 30000,
        'currency': 'ETB',
        'entitlements': ['coc_medicine'],
        'phrasePool': 'coc/Medicine',
    },
    'coc_dentistry': {
        'id': 'coc_dentistry',
        'category': 'coc',
        'label': 'Dental Medicine COC Exam Preparation',
        'priceCents': 30000,
        'currency': 'ETB',
        'entitlements': ['coc_dentistry'],
        'phrasePool': 'coc/Dental Medicine',
    },
    'coc_pharmacy': {
        'id': 'coc_pharmacy',
        'category': 'coc',
        'label': 'Pharmacy COC Exam Preparation',
        'priceCents': 30000,
        'currency': 'ETB',
        'entitlements': ['coc_pharmacy'],
        'phrasePool': 'coc/Pharmacy',
    },
    'coc_engineering': {
        'id': 'coc_engineering',
        'category': 'coc',
        ...
        'phrasePool': 'coc/Engineering',
    },
    'coc_architecture': {
        'id': 'coc_architecture',
        'category': 'coc',
        'label': 'Architecture COC Exam Preparation',
        'priceCents': 30000,
        'currency': 'ETB',
        'entitlements': ['coc_architecture'],
        'phrasePool': 'coc/Architecture',
    },
    'coc_cs_is': {
        'id': 'coc_cs_is',
        'category': 'coc',
        'label': 'Computer Science & Information Science COC Preparation',
        'priceCents': 30000,
        'currency': 'ETB',
        'entitlements': ['coc_cs_is'],
        'phrasePool': 'coc/Computer Science and Information Science',
    },
    'coc_law': {
        'id': 'coc_law',
        'category': 'coc',
